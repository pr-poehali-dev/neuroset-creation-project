      ...
      <header className="container py-6">
        <nav className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">НейроСеть</span>
          </div>
          <Button asChild variant="outline">
            <Link to="/neuro">Открыть нейросеть</Link>
          </Button>
        </nav>
      </header>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2 space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Создайте свою собственную <span className="text-primary">нейросеть</span>
            </h1>
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="relative">
              ...
              <div className="relative bg-card p-8 rounded-lg shadow-lg border">
                ...
                <h3 className="text-xl font-semibold text-center mb-2">Нейросеть готова помочь</h3>
